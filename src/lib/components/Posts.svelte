	...
	const articles: Article[] = [
		{
			...
			description: 'Lorem ipsum odor amet, consectetuer adipiscing elit. Platea suspendisse nostra quis sem; turpis vulputate ad. Imperdiet varius donec gravida; nostra laoreet nunc posuere turpis.',
			date: '2023',
			href: ''
		},
		{
