...
<nav class={classes}>
	...
	>
		...
		<NavigationItem href="#projects" isActive={active == 'projects'}>Skills</NavigationItem>
		<NavigationItem href="#articles" isActive={active == 'articles'}>Projects</NavigationItem>
